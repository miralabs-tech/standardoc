...
import type { ClusterTarget, OverviewScope, TreeOut } from './shell/types';
import {
...
import {
  ...
  buildWorkspaceTree,
} from './shell/explorer-tree';
import {
  buildOverviewPayloadForScope,
  scopeBreadcrumbLabel,
} from './shell/overview-payload';
import { buildEmptyFocusPayload, buildFocusPayload } from './shell/focus-payload';
import {
  buildFileSyntheticDetail,
  buildSymbolDetail,
  fetchSubItems,
} from './shell/symbol-detail';
