...
pub(crate) fn register_all(reg: &mut BuiltinRegistry) {
    ...
    add(
        reg,
        &[
            "stdio", "stdlib", "string", "stdint", "stdbool", "stddef", "stdarg", "math", "assert",
            "ctype", "errno", "time", "signal", "setjmp", "locale", "limits", "float", "inttypes",
            "wchar", "wctype", "iso646", "complex", "fenv", "tgmath", "threads", "stdatomic",
            "stdnoreturn", "stdalign",
        ],
        Kind::Module,
    ...
    add(
        ...
        &[
            ...
            "vsnprintf", "scanf", "fscanf", "sscanf", "puts", "fputs", "fgets", "gets",
            "putchar", "fputc", "getchar", "fgetc", "putc", "getc", "perror",
        ],
        Kind::Function,
        BuiltinTag::Console,
        BuiltinTier::Edge,
    ...
    add(
        reg,
        &[
            "fopen", "freopen", "fclose", "fread", "fwrite", "fseek", "ftell", "rewind",
            "fflush", "feof", "ferror", "clearerr", "remove", "rename", "tmpfile", "tmpnam",
    ...
    add(
        reg,
        &["abort", "exit", "_Exit", "atexit", "at_quick_exit", "quick_exit", "system", "getenv"],
        Kind::Function,
        BuiltinTag::Process,
        BuiltinTier::Edge,
    );
    ...
    add(
        ...
        &[
            ...
            "asinh", "acosh", "atanh", "ceil", "floor", "round", "trunc", "fabs", "fmod",
            "fmax", "fmin", "fma", "hypot", "copysign", "nan", "isnan", "isinf", "isfinite",
            "signbit",
        ],
        Kind::Function,
        BuiltinTag::Math,
    ...
    add(
        reg,
        &["M_PI", "M_E", "M_SQRT2", "INFINITY", "NAN", "HUGE_VAL", "HUGE_VALF"],
        Kind::Value,
        BuiltinTag::Math,
        BuiltinTier::Edge,
    );
    ...
    add(
        reg,
        &[
            "time", "clock", "difftime", "mktime", "gmtime", "localtime", "asctime", "ctime",
            "strftime", "nanosleep",
        ],
        Kind::Function,
        BuiltinTag::Time,
    ...
    add(
        reg,
        &["time_t", "clock_t", "struct tm", "struct timespec", "CLOCKS_PER_SEC"],
        Kind::Type,
        BuiltinTag::Time,
        BuiltinTier::Edge,
    );
    ...
    add(
        ...
        &[
            ...
            "isgraph", "ispunct", "iscntrl", "isxdigit", "toupper", "tolower",
        ],
        Kind::Function,
        BuiltinTag::Custom {
            tag: "ctype".into(),
    ...
    add(
        ...
        &[
            ...
            "uint64_t", "intptr_t", "uintptr_t", "intmax_t", "uintmax_t", "ptrdiff_t", "size_t",
            "ssize_t", "wchar_t", "char16_t", "char32_t", "off_t",
        ],
        Kind::Type,
        BuiltinTag::Memory,
        BuiltinTier::Drop,
